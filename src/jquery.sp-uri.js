...
(function ($) {
    ...
    var methods = {
        ...
        /**
         * Escapes a URI parameter.
         * 
         * This function is equivalent to encodeURIComponent().
         * 
         * Example:
         * ```JavaScript
        ...
        /**
         * Unescapes a URI parameter.
         * 
         * This function is equivalent to decodeURIComponent().
         * 
         * Example:
         * ```JavaScript
         * // the following command prints 'how do you do?'
         * console.log($.spUri('unescapeParam', 'how%20do%20you%20do%3F'));
         * ```
         * 
         * @param {String} value Parameter value
         * 
         ...
         * Escapes a URI.
         * 
         * This function is equivalent to encodeURI().
         * 
         ...
         * Unescape a URI.
         * 
         * This function is equivalent to decodeURI().
         * 
         * @param {String} uri URI
         * 
         * @return {String}
         */
        'unescape': function (uri) {
